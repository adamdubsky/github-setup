...
The first entry in each line contains a unique string ID of the paper followed by binary values indicating whether or not each word in the vocabulary is present (indicated by 1) or absent (indicated by 0) in the paper. Finally, the last entry in the line contains the class label of the paper.
